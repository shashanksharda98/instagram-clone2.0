    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen py-2 -mt-54 px-14 text-center">
                <img className="w-80" src="https://www.instagram.com/static/images/web/mobile_nav_type_logo.png/735145cfe0a4.png" alt="" />
                <p className="font-xs italic">
                    This is not a REAL app, it is built for practice only
                </p>
